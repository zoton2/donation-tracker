    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(max_length=8, verbose_name=b'Currency', choices=[(b'USD', b'US Dollars'), (b'CAD', b'Canadian Dollars'), (b'GBP', b'British Pounds')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paypalcurrency', models.CharField(default=b'USD', max_length=8, verbose_name=b'Currency', choices=[(b'USD', b'US Dollars'), (b'CAD', b'Canadian Dollars'), (b'GBP', b'British Pounds')])),
